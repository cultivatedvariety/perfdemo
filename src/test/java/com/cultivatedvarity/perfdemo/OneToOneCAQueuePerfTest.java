 ...
 */
public class OneToOneCAQueuePerfTest
{
    ...
    public static void main(final String[] args)
            throws Exception
    {
        final OneToOneCAQueuePerfTest test = new OneToOneCAQueuePerfTest();
            ...
            throws Exception
    {
        ...
        final Runnable runner = new OneToOneCAQueuePerfTest.Producer(barrier, queue);
